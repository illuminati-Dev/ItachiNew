...
def __stats__():
    return (
        "𖣘 {} overall warns, across {} chats.\n"
        "𖣘 {} warn filters, across {} chats.".format(
            sql.num_warns(),
            sql.num_warn_chats(),
...
be a sentence, encompass it with quotes, as such: `/addwarn "fight me" This is an violant user`. 
