...
*Admin only:*
 ...
 - /spurge: silently deletes all messages between this and the replied to message.
 - /spurge <integer X>: silently deletes the replied message, and X messages following it if replied to a message.
"""
