...
GIF_ID = 'CgACAgQAAxkBAAEOW_xiG9kCuAyJmR9Laf_lsP2aNonYLAAC8gIAAjNQtVKnOHHQGJML9CME'
...
def pat(update: Update, context: CallbackContext):
    message = update.effective_message
    res = r.get("https://api.otakugifs.xyz/gif?reaction=pat&format=gif").json()
    url = res['url']
...
def meme(update: Update, context: CallbackContext):
    msg = update.effective_message
    meme = r.get("https://meme-api.com/gimme/animememes/").json()
    image = meme.get("url")
