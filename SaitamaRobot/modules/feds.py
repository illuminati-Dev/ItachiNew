...
from SaitamaRobot.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
from SaitamaRobot.modules.helper_funcs.decorators import makicmd as kigcmd, makicallback as kigcallback
...
def __stats__():
    ...
    return "𖣘 {} users banned, in {} federations".format(
