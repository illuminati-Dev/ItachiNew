...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text("I can't act against my association members.")
        elif user_id in DRAGONS:
            message.reply_text(
                "Fighting this Legend here will put user lives at risk."
            )
        elif user_id in DEMONS:
            message.reply_text(
                "Bring an order from Hunter Association to fight a Elite hunter."
            )
        elif user_id in TIGERS:
            message.reply_text(
                "Bring an order from Hunter Association to fight a master Hunter."
            )
        elif user_id in WOLVES:
            message.reply_text("Pros hunter  abilities make them ban immune!")
        else:
...
def temp_ban(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        reply_msg = (
            ...
            f"<code> </code><b>• By:</b> {mention_html(user.id, html.escape(user.first_name))}\n"
...
ROAR_HANDLER = CommandHandler("unbanme", selfunban, run_async=True)
