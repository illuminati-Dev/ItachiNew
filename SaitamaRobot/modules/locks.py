...
@makicmd(command='lock', pass_args=True)
...
@makicmd(command='unlock', pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@makimsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
