...
from SaitamaRobot.utlis.data_parser import search_filler, parse_filler
from SaitamaRobot.utlis.helper import check_user, control_user, rand_key
from SaitamaRobot.utlis.db import get_collection

FILLERS = {}
DC = get_collection('DISABLED_CMDS')

@anibot.on_message(filters.command(['fillers', f"fillers{BOT_NAME}"]))
@control_user
