...
from SaitamaRobot.modules.helper_funcs.misc import convert_gif
...
def kang(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message:
        ...
        packs_text = "Please reply to a sticker, or image or gif to kang it!\n\n**Note☠️:**  Below sticker buttons wont work untill u make packs by using /kang in the bot of all the three formats(png,animated,video)\n\nOh, by the way. here are your packs:\n"
        if packnum > 0:
            ...
            packs = f"t.me/addstickers/{packname}"
        edited_keyboard = InlineKeyboardMarkup( [ [ InlineKeyboardButton( text="Sticker-Pack", url=f"{packs}"), ], [ InlineKeyboardButton( text="Video-Pack", url=f"https://t.me/addstickers/video{user.id}_by_{context.bot.username}"), InlineKeyboardButton( text="Animated-Pack", url=f"https://t.me/addstickers/animated{user.id}_by_{context.bot.username}"), ], ] ) 
        msg.reply_text( packs_text, reply_markup=edited_keyboard, parse_mode=ParseMode.MARKDOWN )
    try:
    ...
    try:
        ...
        if png_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}'s pack by @{context.bot.username}" + extra_version,
        ...
        if webm_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}'s vid-pack by @{context.bot.username}" + extra_version,
...
__help__ = """
  ...
  ➢ `/kang` : reply to a sticker/img/gif to add it to your pack.
  ➢ `/delkang` : reply to your kang Sticker to remove it from your pack
