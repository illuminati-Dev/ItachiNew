...
from telegram import MAX_MESSAGE_LENGTH, ParseMode, Update, InlineKeyboardButton, __version__ as ptbver, InlineKeyboardMarkup, MessageEntity
from pyrogram import __version__ as pyrov
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code>Finding Information In Hunters Portal...</code>", parse_mode=ParseMode.HTML)

    text = (f"╒═══「<b>Information Found In Hunters Portal:</b> 」\n"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'Devil Hunter Association'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Makima_Bot_Updates/4">?⚔️?</a>]'.format(
            bot.username)
