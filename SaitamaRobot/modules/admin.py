...
from SaitamaRobot import DRAGONS, dispatcher, telethn as bot
...
def fullpromote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status in ('administrator', 'creator'):
        message.reply_text("How am I meant to fullpromote someone that's already an admin?")
        return
    ...
    try:
        ...
        if err.message == "User_not_mutual_contact":
            message.reply_text("I can't fullpromote someone who isn't in the group.")
        else:
            message.reply_text("An error occured while promoting.")
        return
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        message.reply_text(
            ...
            " user. Or the user is a bot (beacuse bot cant demote other bot) so I can't act upon them!",
        )
        return
