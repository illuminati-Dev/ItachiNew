...
class STRINGS:
    REPLY_TO_MEDIA = "ℹ️ Please reply to a photo, sticker, or image file."
    UNSUPPORTED_MEDIA_TYPE = "⚠️ <b>Unsupported media type!</b>"
    
    REQUESTING_API_SERVER = "📡 Requesting...."
    
    DOWNLOADING_MEDIA = "⏳ Downloading media..."
    UPLOADING_TO_API_SERVER = "📡 Uploading media... 📶"
