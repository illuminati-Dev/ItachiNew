...
from SaitamaRobot.utlis.helper import check_user, control_user, media_to_image, rand_key
from SaitamaRobot.utlis.data_parser import check_if_adult
from SaitamaRobot.utlis.db import get_collection
from SaitamaRobot.modules.anibotanilist import no_pic
...
@anibot.on_message(filters.command(["whatanime", f"whatanime{BOT_NAME}"]))
@control_user
